...
$(document).ready(function () {
    $("#category_set").change(function () {
        ...
        alert("vybraná kategorie je: " + displayCategoryName.options[displayCategoryName.selectedIndex].value + " &  název kategorie: " + displayCategoryName.options[displayCategoryName.selectedIndex].text);
    });
});
